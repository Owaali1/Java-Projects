...
public class Tree2 {
    ...
    public static void main(String[] args) throws IOException {
        ...
        if (Locate(head, t)) {
            ...
            int lower = t;
            while (!Locate(head, lower)) {
                lower--;
            }
            int Greater = t;
            while (!Locate(head, Greater)) {
                Greater++;
            }

            
            System.out.println("The Nearest Prime Number Greater Than Yours Is "
                    + Greater);
            System.out.println("The Nearest Prime Number Less Than Yours Is "
                    + lower);
